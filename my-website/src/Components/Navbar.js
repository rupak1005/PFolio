  ...
  return (
    <nav className={`Navbar ${hideNavbar ? 'hidden' : ''}`}>
     <h1 title='Reload' onClick={() => window.location.reload(true)} className='Logo'>
      ...
      <li onClick={hideMenu}><Link to="/"><span style={{ marginRight: "5px" }}><AiOutlineHome /></span>Home</Link></li>
      <li onClick={hideMenu}><Link to="/About"><span style={{ marginRight: "5px" }}><BsPerson /></span>About</Link></li>
      <li onClick={hideMenu}><Link to="/Project"><span style={{ marginRight: "5px" }}><BsCodeSlash /></span>Projects</Link></li>
      <li onClick={hideMenu}><Link to="/Resume"><span style={{ marginRight: "5px" }}><CgFileDocument /></span>Resume</Link></li>
      <li onClick={hideMenu}><Link to="/Contact"><span style={{ marginRight: "5px" }}><BsFillEnvelopeFill /></span>Contact</Link></li>
      </ul>
